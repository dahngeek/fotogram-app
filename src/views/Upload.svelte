<script>
    ...
    function handleClick(event) {
        ...
        fetch("http://localhost:5000/api/v1/principal/", {
            method: "POST",
            headers: myHeaders,
            body: formAEnviar
            }).then((response) => {
        ...
        <form class="mt-8 space-y-3" action="#" method="POST">
                    <div class="grid grid-cols-1 space-y-2">
                        <label class="text-sm font-bold text-gray-500 tracking-wide">Titulo</label>
                            <input bind:value={datos.caption} class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" type="text" placeholder="Mis vacacione en aruba...">
                    </div>
                    <div class="grid grid-cols-1 space-y-2">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label class="flex flex-col rounded-lg border-4 border-dashed w-full h-60 p-10 group text-center">
                                <div class="h-full w-full text-center flex flex-col items-center justify-center items-center  ">
                                    ...
                                    <p class="pointer-none text-gray-500 ">Aquí puedes <a href="" id="" class="text-blue-600 hover:underline">seleccionar una foto</a> de tu computadora, para publicar.</p>
                                </div>
                    ...
                    <div class="grid grid-cols-1 space-y-2">
                        <label class="text-sm font-bold text-gray-500 tracking-wide">Etiquetas:</label>
                            <input bind:value={datos.tags} class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" type="text" placeholder="Viaje, comida, etc.">
                    </div>
                    <div>
